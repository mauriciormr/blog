...
<script>
import { txtInsert } from './toolbar-utils'
import Emoji from '~/components/toolbar/emoji-picker/Emoji.vue'
...
export default {
  ...
  methods: {
    insertText(type) {
      txtInsert(this.dom, type, this)
    },
    updateContentFromToolbar(content) {
      this.$emit('updateContentFromToolbar', content)
    }
  }
}
</script>
