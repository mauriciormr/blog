<template>
  <div class="resource-not-found">
    <svg
      ...
      class="resource-not-found__error-image"
    >
      <defs>
        <linearGradient
    ...
    <h2 class="resource-not-found__title">
      ¡Oops!
    </h2>
    <h1 v-if="showCode" class="resource-not-found__code">
      {{ err.statusCode }}
    </h1>
    <p class="resource-not-found__message">
      {{ err.message }}
    </p>
  </div>
</template>
